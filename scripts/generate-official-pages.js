...
const PROVENANCE_HOST_EXTRA = new Set([
  ...
  // 同町の来歴節が丸ごと消える（日向市の回帰と同型）。トップページに町役場の住所
  ...
  // トップページに市役所の住所（北海道紋別市幸町2丁目1番18号）・電話 0158-24-2111・
  // (C) 2023 MOMBETSU CITY があり、乗っ取りを示す語句は検出されなかった。
  "mombetsu.jp",                 // 紋別市（北海道）
  ...
  // 乗っ取りを示す語句は検出されなかった。
  // 中標津町: 〒086-1197 北海道標津郡中標津町丸山2丁目22番地 TEL 0153-73-3111 /
  //           (C) 2015 Town of Nakashibetsu, Hokkaido
  "www.nakashibetsu.jp",         // 中標津町（北海道）
  // 新冠町: 〒059-2492 北海道新冠郡新冠町字北星町3番地の2 電話 0146-47-2111 /
  //         (C) Niikappu Town. All Rights Reserved.
  "www.niikappu.jp",             // 新冠町（北海道）
  // 更別村: 〒089-1595 北海道河西郡更別村字更別南1線93番地 TEL 0155-52-2111 /
  //         法人番号 7000020016390（cityCode 01639 と対応）/ (C) 2017 SARABETSU VILLAGE, HOKKAIDO
  ...
  // トップページに「〒098-5892 枝幸郡枝幸町本町916番地 代表電話：0163-62-1234」と
  // (C) ESASHI TOWN があり、「江差」の語は0件（2026-09-02 実測）。
