# 熊本市 R7 → R8 lifecycle retrofit

## source

- sourceStatus: official_rate_page
- URL: https://www.city.kumamoto.jp/kiji003426/index.html

- 既存 audit 記録(前セッションで R8 値検証済): verifiedAt 2026-04-08, method official-site
- 値クロスチェック: 2026-05-21(r8-values-collected-2026-05-21.md A 分類 #6 で全項目再確認、対比一致)
...
熊本県政令指定都市、介護分平等割なし、子ども分公式表記「料率 1,600 円 / 賦課額 18 歳以上 1,700 円・18 歳未満 0 円」。実装は perCapita 1,600 + perCapitaAdult 100 + scope:all_ages(sakai 同型)。県名衝突は prefectureSlug 別フィールドで解決済。
