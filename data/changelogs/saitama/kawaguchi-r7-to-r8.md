# 川口市 R7 → R8 lifecycle retrofit

## source

- sourceStatus: official_rate_page
- URL: https://www.city.kawaguchi.lg.jp/soshiki/01090/030/kokuminkenkouhokenzei/50549.html
- 追加 URL: https://www.city.kawaguchi.lg.jp/soshiki/01090/030/kokuminkenkouhokenzei/3336.html
- 既存 audit 記録(前セッションで R8 値検証済): verifiedAt 2026-04-08, method official-site
- 値クロスチェック: 2026-05-21(r8-values-collected-2026-05-21.md A 分類 #6j で全項目再確認、対比一致)
...
埼玉県中核市、平等割なし(さいたま・越谷・川越・船橋と同じ埼玉県パターン)、18 歳以上加算なし、子ども分 18 歳未満 0 円(さいたま型 under18Reduction で表現可能)、医療限度額 66 万(国基準 67 万未到達)。
