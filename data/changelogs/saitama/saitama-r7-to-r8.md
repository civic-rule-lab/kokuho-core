# さいたま市 R7 → R8 lifecycle retrofit

## source

- sourceStatus: official_rate_page
- URL: https://www.city.saitama.lg.jp/001/153/002/004/p010020.html
- 追加 URL: https://www.city.saitama.lg.jp/001/153/002/004/p053074.html
- 既存 audit 記録(前セッションで R8 値検証済): verifiedAt 2026-04-08, method official-site
- 値クロスチェック: 2026-05-21(r8-values-collected-2026-05-21.md A 分類 #8 で全項目再確認、対比一致)
...
- meta.lifecycle.sourceUrls: 新規 (上記 2 件の URL 配列)
...
埼玉県政令指定都市、平等割なし、子ども分 18 歳未満不課税(engine の under18Reduction フラグで表現)。handoff-2026-05-22 で「県名衝突回避で saitamacity 採用」と誤記録があったが、実際は registry が `saitama` で登録されており `-city` suffix 不要。
