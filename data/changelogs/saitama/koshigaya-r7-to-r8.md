# 越谷市 R7 → R8 lifecycle retrofit

## source

- sourceStatus: official_rate_page
- URL: https://www.city.koshigaya.saitama.jp/kurashi_shisei/fukushi/kokuho/kokuhokanyudattai/r8zeiritsuhenko.html

- 既存 audit 記録(前セッションで R8 値検証済): verifiedAt 2026-05-11, method official-site
- 値クロスチェック: 2026-05-21(r8-values-collected-2026-05-21.md A 分類 #6f で全項目再確認、対比一致)
...
埼玉県中核市、平等割なし(さいたまと同じ埼玉県パターン)、18 歳以上加算 151 円、医療限度額 66 万(国基準 67 万未到達)。
