# 平塚市 R7 → R8 lifecycle retrofit

## source

- sourceStatus: official_rate_page
- URL: https://www.city.hiratsuka.kanagawa.jp/nenkin/page-c_00081.html
...
神奈川県平塚市、市公式の R8 国保税試算用紙ページから取得。method: official-pdf(PDF 試算用紙経由で値確認)。
