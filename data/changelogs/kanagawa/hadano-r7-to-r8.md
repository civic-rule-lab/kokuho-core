# 秦野市 R7 → R8 lifecycle retrofit

## source

- sourceStatus: official_rate_page
- URL: https://www.city.hadano.kanagawa.jp/soshiki/5/1038/5/4/5037.html
- 既存 audit 記録(前セッションで R8 値検証済): verifiedAt 2026-05-08, method official-site
...
神奈川県秦野市、当初は公式試算ツール経由で値取得(audit.method: official-tool)。本 retrofit 適用時に市公式の R8 税率ページが公開済であることを確認し sourceUrls に追加(meta.source.url は空のまま preserve)。子ども分は sakai pattern(perCapita 1,150 + perCapitaAdult 50 = 表示均等割 1,200)。
