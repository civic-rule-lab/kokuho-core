# 松山市 R7 → R8 lifecycle retrofit

## source

- sourceStatus: official_rate_page
- URL: https://www.city.matsuyama.ehime.jp/kurashi/tetsuzuki/kokuho/kokuhoryokinn/r8kokuhoryou.html

- 既存 audit 記録(前セッションで R8 値検証済): verifiedAt 2026-04-08, method official-site
- 値クロスチェック: 2026-05-21(r8-values-collected-2026-05-21.md A 分類 #6b で全項目再確認、対比一致)
...
愛媛県中核市、子ども分均等割は「18 歳から 74 歳の加入者の人数」に対してのみ課金、18 歳未満は不課税(さいたま市と同型、childcare.under18Reduction: true で engine 表現可能)。
