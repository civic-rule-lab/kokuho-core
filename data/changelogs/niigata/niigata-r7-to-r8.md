# 新潟市 R7 → R8 lifecycle retrofit

## source

- sourceStatus: official_rate_page
- URL: https://www.city.niigata.lg.jp/kurashi/hoken/kokuho/hokenryo/henko.html

- 既存 audit 記録(前セッションで R8 値検証済): verifiedAt 2026-04-08, method official-site
- 値クロスチェック: 2026-05-21(r8-values-collected-2026-05-21.md A 分類 #6d で全項目再確認、対比一致)
...
新潟県政令指定都市、介護分・子ども分に平等割なし、18 歳以上加算なし。県名衝突は prefectureSlug 別フィールドで解決済、`-city` suffix 不要。
