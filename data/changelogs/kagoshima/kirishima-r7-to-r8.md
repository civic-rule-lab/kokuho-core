# 霧島市 R7 → R8 lifecycle retrofit

## source

- sourceStatus: official_rate_page
- URL: https://www.city-kirishima.jp/zeimu/kurashi/zekin/hokenze/kokumin/index.html
...
鹿児島県霧島市、市公式の国保税率ページから取得。鹿児島県は 4 制度すべて 3 方式統一の県標準保険料率を公表済み。
