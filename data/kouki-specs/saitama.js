/**
 * 埼玉県 後期高齢者医療スペック（令和8・9年度 / 2026年度）
 *
 ...
 *   出典: https://www.saitama-koukikourei.org/seido/hokenryo-2/keigen/page-9674-4/
...
export const PREF_SLUG = "saitama";
...
export const SOURCE = {
  ...
  kansho: { url: "https://www.saitama-koukikourei.org/seido/hokenryo-2/keigen/page-9674-4/", note: "所得割独自軽減なし・県内均一", confidence: 0.90, retrievedAt: "2026-06-28" },
};

// 県ごとに変わる料率（医療分・子ども分）と、広域連合独自の所得割軽減。
export const KOUKI = {
  perCapita: { medical: 52370, childcare: 1330 },   // 均等割額（円/年）
  rate:      { medical: 0.0949, childcare: 0.0025 },   // 所得割率
