/**
 * 福井県 後期高齢者医療スペック（令和8・9年度 / 2026年度）
 *
 ...
 *   出典: https://www.fukui-kouiki.or.jp/post-11.html
...
export const SOURCE = {
  ...
  kansho: { url: "https://www.fukui-kouiki.or.jp/post-11.html", note: "所得割独自軽減なし・県内均一", confidence: 0.95, retrievedAt: "2026-06-28" },
};

// 県ごとに変わる料率（医療分・子ども分）と、広域連合独自の所得割軽減。
export const KOUKI = {
  perCapita: { medical: 54140, childcare: 1300 },   // 均等割額（円/年）
  rate:      { medical: 0.1083, childcare: 0.0026 },   // 所得割率
