/**
 * 石川県 後期高齢者医療スペック（令和8・9年度 / 2026年度）
 *
 ...
 *   出典: http://www.ishikawa-kouiki.jp/healthcare/insurance_fee/calculation/
...
export const SOURCE = {
  ...
  kansho: { url: "http://www.ishikawa-kouiki.jp/healthcare/insurance_fee/calculation/", note: "所得割独自軽減なし・県内均一", confidence: 0.95, retrievedAt: "2026-06-28" },
};

// 県ごとに変わる料率（医療分・子ども分）と、広域連合独自の所得割軽減。
export const KOUKI = {
  perCapita: { medical: 57300, childcare: 1360 },   // 均等割額（円/年）
  rate:      { medical: 0.1114, childcare: 0.0024 },   // 所得割率
