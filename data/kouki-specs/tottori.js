 ...
 *
 * 関所（所得割の独自軽減 / 不均一賦課）: 所得割独自軽減なし・県内均一(条例)
...
export const SOURCE = {
  ...
  kansho: { url: "http://koureikouiki-tottori.jp/medical-care/392", note: "所得割独自軽減なし・県内均一(条例)", confidence: 0.85, retrievedAt: "2026-06-28" },
};
