/**
 * 熊本県 後期高齢者医療スペック（令和8・9年度 / 2026年度）
 *
 ...
 *   出典: https://www.kumamoto-kouikirengo.jp/system2/insurance.html
 *   確認度(confidence): 0.88（2026-06-28 公式裏取り：軽減は全国一律7.2割/5割/2割＋被扶養者2年5割のみ・独自軽減なし(公式に「県内で均一」明記)）
 *
...
export const SOURCE = {
  ...
  kansho: { url: "https://www.kumamoto-kouikirengo.jp/system2/insurance.html", note: "所得割独自軽減なし・県内均一(公式広域連合ページで裏取り＝軽減は全国一律7.2割/5割/2割＋被扶養者2年5割のみ)(公式に「県内で均一」明記)", confidence: 0.88, retrievedAt: "2026-06-28" },
};

// 県ごとに変わる料率（医療分・子ども分）と、広域連合独自の所得割軽減。
export const KOUKI = {
  perCapita: { medical: 63000, childcare: 1400 },   // 均等割額（円/年）
  rate:      { medical: 0.1106, childcare: 0.0025 },   // 所得割率
