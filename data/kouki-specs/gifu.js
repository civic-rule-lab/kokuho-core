/**
 * 岐阜県 後期高齢者医療スペック（令和8・9年度 / 2026年度）
 *
 ...
 *
 * 関所（所得割の独自軽減 / 不均一賦課）: 所得割独自軽減なし(附則特例はH29失効)・県内均一(条例明文)
 *   出典: https://www1.g-reiki.net/gikouiki/reiki_honbun/u362RG00000084.html
...
export const SOURCE = {
  ...
  kansho: { url: "https://www1.g-reiki.net/gikouiki/reiki_honbun/u362RG00000084.html", note: "所得割独自軽減なし(附則特例はH29失効)・県内均一(条例明文)", confidence: 0.95, retrievedAt: "2026-06-28" },
};

// 県ごとに変わる料率（医療分・子ども分）と、広域連合独自の所得割軽減。
export const KOUKI = {
  perCapita: { medical: 55385, childcare: 1374 },   // 均等割額（円/年）
  rate:      { medical: 0.0971, childcare: 0.0025 },   // 所得割率
