/**
 * 大分県 後期高齢者医療スペック（令和8・9年度 / 2026年度）
 *
...
export const SOURCE = {
  ...
  kansho: { url: "http://oita-kouiki.jp/", note: "所得割独自軽減なし・県内全域均一(公式明記)", confidence: 0.90, retrievedAt: "2026-06-28" },
};

// 県ごとに変わる料率（医療分・子ども分）と、広域連合独自の所得割軽減。
export const KOUKI = {
  perCapita: { medical: 64200, childcare: 1400 },   // 均等割額（円/年）
  rate:      { medical: 0.1125, childcare: 0.0024 },   // 所得割率
