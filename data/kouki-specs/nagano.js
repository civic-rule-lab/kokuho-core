/**
 * 長野県 後期高齢者医療スペック（令和8・9年度 / 2026年度）
 *
 ...
 *   出典: https://www.koukikourei-nagano.jp/docs/408.html
 *   確認度(confidence): 0.9（2026-06-28 公式裏取り：軽減は全国一律7.2割/5割/2割＋被扶養者2年5割のみ・独自軽減なし）
 *
...
export const SOURCE = {
  ...
  kansho: { url: "https://www.koukikourei-nagano.jp/docs/301.html", note: "所得割独自軽減なし・県内均一(公式広域連合ページで裏取り＝軽減は全国一律7.2割/5割/2割＋被扶養者2年5割のみ)", confidence: 0.9, retrievedAt: "2026-06-28" },
};

// 県ごとに変わる料率（医療分・子ども分）と、広域連合独自の所得割軽減。
export const KOUKI = {
  perCapita: { medical: 48827, childcare: 1339 },   // 均等割額（円/年）
  rate:      { medical: 0.088, childcare: 0.0025 },   // 所得割率
