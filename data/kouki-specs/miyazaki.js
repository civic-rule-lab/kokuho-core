 ...
 *
 * 関所（所得割の独自軽減 / 不均一賦課）: 所得割独自軽減なし・県内原則均一
...
export const SOURCE = {
  ...
  kansho: { url: "https://www.miyazaki-kourei-kouiki.jp/system/fee/rule/", note: "所得割独自軽減なし・県内原則均一", confidence: 0.85, retrievedAt: "2026-06-28" },
};
