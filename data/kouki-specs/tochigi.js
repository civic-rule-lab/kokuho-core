/**
 * 栃木県 後期高齢者医療スペック（令和8・9年度 / 2026年度）
 *
 ...
 *
 * 関所（所得割の独自軽減 / 不均一賦課）: 所得割独自軽減なし・県内均一（公式保険料ページで確認・単一広域連合）
 *   出典: https://www.kouikirengo-tochigi.jp/seido/insurance.html
 *   確認度(confidence): 0.93（2026-06-28 公式裏取り：軽減は全国一律7.2割/5割/2割＋被扶養者2年5割＋一般減免のみ・独自軽減なし）
 *
...
export const PREF_SLUG = "tochigi";
...
export const SOURCE = {
  ...
  kansho: { url: "https://www.kouikirengo-tochigi.jp/seido/insurance.html", note: "所得割独自軽減なし・県内均一(公式保険料ページで確認＝全国一律7.2割/5割/2割＋被扶養者2年5割＋一般減免のみ・単一広域連合)", confidence: 0.93, retrievedAt: "2026-06-28" },
};

// 県ごとに変わる料率（医療分・子ども分）と、広域連合独自の所得割軽減。
export const KOUKI = {
  perCapita: { medical: 49100, childcare: 1300 },   // 均等割額（円/年）
  rate:      { medical: 0.09, childcare: 0.0025 },   // 所得割率
