 ...
 *
 * 関所（所得割の独自軽減 / 不均一賦課）: 所得割独自軽減なし(記載なし)・県内均一
...
export const SOURCE = {
  ...
  kansho: { url: "https://www.kouikirengo-tochigi.jp/seido/insurance.html", note: "所得割独自軽減なし(記載なし)・県内均一", confidence: 0.80, retrievedAt: "2026-06-28" },
};
