/**
 * 奈良県 後期高齢者医療スペック（令和8・9年度 / 2026年度）
 *
 ...
 *   出典: https://www.city.nara.lg.jp/soshiki/38/204494.html
 *   確認度(confidence): 0.85（2026-06-28 公式裏取り：軽減は全国一律7.2割/5割/2割＋被扶養者2年5割のみ・独自軽減なし(広域連合一次ページ直読不可・奈良市公式で裏取り)）
 *
...
export const SOURCE = {
  ...
  kansho: { url: "https://ssl.nara-kouiki.jp/seido_hokenryou2.html", note: "所得割独自軽減なし・県内均一(公式広域連合ページで裏取り＝軽減は全国一律7.2割/5割/2割＋被扶養者2年5割のみ)(広域連合一次ページ直読不可・奈良市公式で裏取り)", confidence: 0.85, retrievedAt: "2026-06-28" },
};

// 県ごとに変わる料率（医療分・子ども分）と、広域連合独自の所得割軽減。
export const KOUKI = {
  perCapita: { medical: 57100, childcare: 1400 },   // 均等割額（円/年）
  rate:      { medical: 0.1063, childcare: 0.0025 },   // 所得割率
