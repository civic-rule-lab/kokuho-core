 ...
 *
 * 関所（所得割の独自軽減 / 不均一賦課）: 所得割独自軽減なし・県内単一(広域公式はJS制御のため奈良市ページで確認)
 *   出典: https://www.city.nara.lg.jp/soshiki/38/204494.html
 *   確認度(confidence): 0.80（2026-06-28 調査）
 *
...
export const SOURCE = {
  ...
  kansho: { url: "https://www.city.nara.lg.jp/soshiki/38/204494.html", note: "所得割独自軽減なし・県内単一(広域公式はJS制御のため奈良市ページで確認)", confidence: 0.80, retrievedAt: "2026-06-28" },
};
