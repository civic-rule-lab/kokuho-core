/**
 * 岩手県 後期高齢者医療スペック（令和8・9年度 / 2026年度）
 *
 ...
 *
 * 関所（所得割の独自軽減 / 不均一賦課）: 所得割独自軽減なし・県内均一(公式明記)
 *   出典: https://iwate-kouiki.jp/system/insurance/r89hokenryo/
 *   確認度(confidence): 0.93（2026-06-28 調査）
 *
...
export const SOURCE = {
  ...
  kansho: { url: "https://iwate-kouiki.jp/system/insurance/r89hokenryo/", note: "所得割独自軽減なし・県内均一(公式明記)", confidence: 0.93, retrievedAt: "2026-06-28" },
};

// 県ごとに変わる料率（医療分・子ども分）と、広域連合独自の所得割軽減。
export const KOUKI = {
  perCapita: { medical: 48800, childcare: 1366 },   // 均等割額（円/年）
  rate:      { medical: 0.085, childcare: 0.0026 },   // 所得割率
