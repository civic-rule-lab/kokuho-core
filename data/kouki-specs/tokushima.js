/**
 * 徳島県 後期高齢者医療スペック（令和8・9年度 / 2026年度）
 *
 ...
 *   出典: https://www.koukikourei-tokushima.jp/docs/2022012000012/
...
export const SOURCE = {
  ...
  kansho: { url: "https://www.koukikourei-tokushima.jp/docs/2022012000012/", note: "所得割独自軽減なし・県内均一(公式明記)", confidence: 0.95, retrievedAt: "2026-06-28" },
};

// 県ごとに変わる料率（医療分・子ども分）と、広域連合独自の所得割軽減。
export const KOUKI = {
  perCapita: { medical: 60976, childcare: 1356 },   // 均等割額（円/年）
  rate:      { medical: 0.1091, childcare: 0.0025 },   // 所得割率
