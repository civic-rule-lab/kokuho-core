/**
 * 山形県 後期高齢者医療スペック（令和8・9年度 / 2026年度）
 *
 ...
 *   出典: https://www.yamagata-kouiki.jp/insurance/entry-96.html
...
export const SOURCE = {
  ...
  kansho: { url: "https://www.yamagata-kouiki.jp/insurance/entry-96.html", note: "所得割独自軽減なし・県内均一", confidence: 0.90, retrievedAt: "2026-06-28" },
};

// 県ごとに変わる料率（医療分・子ども分）と、広域連合独自の所得割軽減。
export const KOUKI = {
  perCapita: { medical: 52500, childcare: 1373 },   // 均等割額（円/年）
  rate:      { medical: 0.0963, childcare: 0.0025 },   // 所得割率
