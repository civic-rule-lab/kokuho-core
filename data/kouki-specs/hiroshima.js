/**
 * 広島県 後期高齢者医療スペック（令和8・9年度 / 2026年度）
 *
 ...
 *
 * 関所（所得割の独自軽減 / 不均一賦課）: 所得割独自軽減なし・県内一律
 *   出典: http://www.kouiki-hiroshima.jp/seido/hokenryou/index.html
...
export const SOURCE = {
  ...
  kansho: { url: "http://www.kouiki-hiroshima.jp/seido/hokenryou/index.html", note: "所得割独自軽減なし・県内一律", confidence: 0.90, retrievedAt: "2026-06-28" },
};

// 県ごとに変わる料率（医療分・子ども分）と、広域連合独自の所得割軽減。
export const KOUKI = {
  perCapita: { medical: 55090, childcare: 1337 },   // 均等割額（円/年）
  rate:      { medical: 0.0993, childcare: 0.0025 },   // 所得割率
