/**
 * 新潟県 後期高齢者医療スペック（令和8・9年度 / 2026年度）
 *
 ...
 *
 * 関所（所得割の独自軽減 / 不均一賦課）: 所得割独自軽減なし・県内統一
 *   出典: https://www.niigata-kouiki.jp/system/insurance_premium/reduction.html
 *   確認度(confidence): 0.90（2026-06-28 調査）
 *
...
export const PREF_SLUG = "niigata";
...
export const SOURCE = {
  ...
  kansho: { url: "https://www.niigata-kouiki.jp/system/insurance_premium/reduction.html", note: "所得割独自軽減なし・県内統一", confidence: 0.90, retrievedAt: "2026-06-28" },
};

// 県ごとに変わる料率（医療分・子ども分）と、広域連合独自の所得割軽減。
export const KOUKI = {
  perCapita: { medical: 49200, childcare: 1354 },   // 均等割額（円/年）
  rate:      { medical: 0.0861, childcare: 0.0026 },   // 所得割率
