/**
 * 三重県 後期高齢者医療スペック（令和8・9年度 / 2026年度）
 *
 ...
 *   出典: https://mie-kouiki.jp/kouki/hokenryou/
...
export const SOURCE = {
  ...
  kansho: { url: "https://mie-kouiki.jp/kouki/hokenryou/", note: "所得割独自軽減なし・県内単一", confidence: 0.90, retrievedAt: "2026-06-28" },
};

// 県ごとに変わる料率（医療分・子ども分）と、広域連合独自の所得割軽減。
export const KOUKI = {
  perCapita: { medical: 54843, childcare: 1370 },   // 均等割額（円/年）
  rate:      { medical: 0.0953, childcare: 0.0025 },   // 所得割率
