/**
 * 愛媛県 後期高齢者医療スペック（令和8・9年度 / 2026年度）
 *
 ...
 *   出典: https://www.ehime-kouiki.jp/hokenryo/
...
export const SOURCE = {
  ...
  kansho: { url: "https://www.ehime-kouiki.jp/hokenryo/", note: "所得割独自軽減なし・県内統一(公式明記)", confidence: 0.95, retrievedAt: "2026-06-28" },
};

// 県ごとに変わる料率（医療分・子ども分）と、広域連合独自の所得割軽減。
export const KOUKI = {
  perCapita: { medical: 55630, childcare: 1320 },   // 均等割額（円/年）
  rate:      { medical: 0.0979, childcare: 0.0025 },   // 所得割率
