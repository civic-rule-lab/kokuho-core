/**
 * 大阪府 後期高齢者医療スペック（令和8・9年度 / 2026年度）
 *
 ...
 *
 * 関所（所得割の独自軽減 / 不均一賦課）: 所得割独自軽減なし・府内均一(公式明記)
 *   出典: https://www.kouikirengo-osaka.jp/longlife/insurance.html
...
export const SOURCE = {
  ...
  kansho: { url: "https://www.kouikirengo-osaka.jp/longlife/insurance.html", note: "所得割独自軽減なし・府内均一(公式明記)", confidence: 0.95, retrievedAt: "2026-06-28" },
};

// 県ごとに変わる料率（医療分・子ども分）と、広域連合独自の所得割軽減。
export const KOUKI = {
  perCapita: { medical: 64931, childcare: 1373 },   // 均等割額（円/年）
  rate:      { medical: 0.1151, childcare: 0.0024 },   // 所得割率
