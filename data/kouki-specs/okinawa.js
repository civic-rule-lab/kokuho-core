/**
 * 沖縄県 後期高齢者医療スペック（令和8・9年度 / 2026年度）
 *
 ...
 *
 * 関所（所得割の独自軽減 / 不均一賦課）: 所得割独自軽減なし・不均一賦課はH25終了し以降均一(公式明記)
 *   出典: https://www.kouiki-okinawa.jp/hokenryou.html
...
export const SOURCE = {
  ...
  kansho: { url: "https://www.kouiki-okinawa.jp/hokenryou.html", note: "所得割独自軽減なし・不均一賦課はH25終了し以降均一(公式明記)", confidence: 0.95, retrievedAt: "2026-06-28" },
};

// 県ごとに変わる料率（医療分・子ども分）と、広域連合独自の所得割軽減。
export const KOUKI = {
  perCapita: { medical: 61000, childcare: 1290 },   // 均等割額（円/年）
  rate:      { medical: 0.1081, childcare: 0.0026 },   // 所得割率
