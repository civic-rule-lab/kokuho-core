/**
 * 山口県 後期高齢者医療スペック（令和8・9年度 / 2026年度）
 *
 ...
 *   出典: http://yamaguchi-kouiki.jp/ko/ko03
...
export const PREF_SLUG = "yamaguchi";
...
export const SOURCE = {
  ...
  kansho: { url: "http://yamaguchi-kouiki.jp/ko/ko03-2/ko0302", note: "所得割独自軽減なし・県内均一(公式広域連合ページで裏取り＝軽減は全国一律7.2割/5割/2割＋被扶養者2年5割のみ)", confidence: 0.92, retrievedAt: "2026-06-28" },
};

// 県ごとに変わる料率（医療分・子ども分）と、広域連合独自の所得割軽減。
export const KOUKI = {
  perCapita: { medical: 63513, childcare: 1354 },   // 均等割額（円/年）
  rate:      { medical: 0.1136, childcare: 0.0024 },   // 所得割率
