/**
 * 香川県 後期高齢者医療スペック（令和8・9年度 / 2026年度）
 *
 ...
 *   出典: https://kagawa-kouiki.jp/fee/page-368
...
export const SOURCE = {
  ...
  kansho: { url: "https://kagawa-kouiki.jp/fee/page-368", note: "所得割独自軽減なし・県内一律", confidence: 0.80, retrievedAt: "2026-06-28" },
};

// 県ごとに変わる料率（医療分・子ども分）と、広域連合独自の所得割軽減。
export const KOUKI = {
  perCapita: { medical: 58000, childcare: 1300 },   // 均等割額（円/年）
