 ...
 *   政令市: なし
 *
 * データ出典: https://www.pref.fukui.lg.jp/doc/zeimu/type/kojinkenmin.html (2026年4月)
 */
...
export const PREF_SOURCE = {
  url:         'https://www.pref.fukui.lg.jp/doc/zeimu/type/kojinkenmin.html',
  retrievedAt: '2026-05-01',
  notes:       '福井県公式ページで均等割1,000円・所得割4%（超過課税なし）確認',
};
