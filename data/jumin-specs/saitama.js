 ...
 *
 * データ出典: https://www.pref.saitama.lg.jp/a0209/z-kurashiindex/z-2-1.html (2026年4月)
 */
...
export const PREF_SOURCE = {
  url:         'https://www.pref.saitama.lg.jp/a0209/z-kurashiindex/z-2-1.html',
  retrievedAt: '2026-04-30',
  notes:       '埼玉県公式ページで均等割1,000円・所得割4%（超過課税なし）確認',
};
...
export const MUNICIPALITIES = [
  {
    ...
    status: "verified",
    source: {
      url: "https://www.city.saitama.lg.jp/001/153/004/002/001/001/p013654.html",
      pageTitle: "個人市民税・県民税の税額の計算方法 - さいたま市",
      retrievedAt: "2026-04-30",
    },
