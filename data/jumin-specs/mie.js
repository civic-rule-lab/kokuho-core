 ...
 *
 * データ出典: https://www.pref.mie.lg.jp/ZEIMU/HP/80013017950.htm (2026-05-01)
 */
...
export const PREF_SOURCE = {
  url:         'https://www.pref.mie.lg.jp/ZEIMU/HP/80013017950.htm',
  retrievedAt: '2026-04-30',
  notes:       '三重県公式ページでみえ森と緑の県民税+1,000円確認',
};

export const PREF_DEFAULTS = {
  prefRate:      0.04,         // 確認済み: 所得割超過課税なし（標準4%）
  prefPerCapita: 2000,     // みえ森と緑の県民税: 標準1,000 + 1000円
};
