 ...
 *
 * データ出典: https://www.pref.niigata.lg.jp/sec/zeimu/kkenmin.html (2026年4月)
 */
...
export const PREF_SOURCE = {
  url:         'https://www.pref.niigata.lg.jp/sec/zeimu/kkenmin.html',
  retrievedAt: '2026-04-30',
  notes:       '新潟県公式ページで均等割1,000円・所得割4%（超過課税なし）確認',
};
...
export const MUNICIPALITIES = [
  {
    ...
    status: "verified",
    source: {
      url: "https://www.city.niigata.lg.jp/kurashi/zei/siraberu/kojin/kojingaiyou.html",
      pageTitle: "個人市民税の概要 - 新潟市",
      retrievedAt: "2026-04-30",
    },
